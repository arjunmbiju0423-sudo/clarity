...
const fsSource = `
  ...
  void main() {
    ...
    vec4 bgColor1 = vec4(0.01, 0.04, 0.14, 1.0);
    vec4 bgColor2 = vec4(0.02, 0.06, 0.20, 1.0);
    ...
    for(int l = 0; l < linesPerGroup; l++) {
      ...
      line = line + circle;
      // Dark lines — near-black with very slight navy tint
      lines += line * vec4(0.0, 0.02, 0.06, 1.0) * rand * 2.5;
    }
